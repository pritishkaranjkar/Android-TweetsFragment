...
import com.codepath.apps.twitter.mysimpletweets.activities.ProfileActivity;
...
public abstract class TweetsListFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        rvTweets.addOnScrollListener(new com.codepath.apps.twitter.mysimpletweets.utils.EndlessRecyclerViewScrollListener(linearLayoutManager) {
            @Override
